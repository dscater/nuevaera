...
<body>
    ...
    <div class="encabezado">
        ...
        <h4 class="texto">ORDEN DE VENTAS</h4>
        <h4 class="fecha">Expedido: {{ date('d-m-Y') }}</h4>
    </div>
    @foreach ($orden_ventas as $orden)
        <table border="1">
            <thead class="green">
                <tr>
                    <th class="izquierda" width="15%">Fecha y hora:</th>
                    <th class="izquierda" colspan="3">{{ date('d/m/Y H:i', strtotime($orden->created_at)) }}</th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <th class="izquierda" colspan="3">{{ $orden->nit }}</th>
                </tr>
                <tr>
                    <th class="izquierda">
                        Caja:
                    </th>
                    <th class="izquierda" colspan="3">{{ $orden->user->usuario }}</th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="bold centreado">{{ $orden->total }}</td>
                </tr>
            </tbody>
        </table>
    @endforeach
