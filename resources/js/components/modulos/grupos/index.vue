...
export default {
    ...
    methods: {
        ...
        getGrupos() {
            ...
            axios
                ...
                .then((res) => {
                    ...
                    this.listRegistros = res.data.grupos;
                    this.totalRows = res.data.total;
                });
        },
        eliminaGrupo(id, descripcion) {
            Swal.fire({
        ...
        abreModal(tipo_accion = "nuevo", grupo = null) {
            this.muestra_modal = true;
