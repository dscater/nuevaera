...
export default {
    ...
    methods: {
        ...
        editarRegistro(item) {
            ...
            this.oSucursal.codigo = item.codigo ? item.codigo : "";
            this.oSucursal.nombre = item.nombre ? item.nombre : "";
            this.oSucursal.dir = item.dir ? item.dir : "";
            this.oSucursal.fono = item.fono ? item.fono.split("; ") : "";
            this.oSucursal.responsable = item.responsable
                ? item.responsable
                : "";
        ...
        limpiaSucursal() {
            this.oSucursal.codigo = "";
            this.oSucursal.nombre = "";
            this.oSucursal.dir = "";
            this.oSucursal.fono = [];
            this.oSucursal.responsable = "";
        },
        formatoFecha(date) {
